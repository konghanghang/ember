...
1. 若后续再出现大规模设计一致性问题，另开新提案，不在本文件续写
...
**目标**：使 `docs/reference/web-design-guide.md` 成为完整的设计系统参考，覆盖所有已实现的模式。

**修改文件**：`docs/reference/web-design-guide.md`
...
```
┌─────────────────────────────────────────────┐
│  Step 1: 更新 web-design-guide.md           │  ← 先立规矩
│  (文档更新，无代码依赖)                        │
└──────────────────┬──────────────────────────┘
                   │
┌──────────────────▼──────────────────────────┐
...
| 文件路径 | 改动类型 |
|---------|---------|
| `docs/reference/web-design-guide.md` | 新增 6 个章节 + 更新 2 个现有章节 |

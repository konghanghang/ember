...
var (
	...
	ErrPersonalAccountMissing     = errors.New("direct play personal 115 account missing")
	ErrAccountConcurrencyExceeded = errors.New("direct play 115 account concurrency exceeded")

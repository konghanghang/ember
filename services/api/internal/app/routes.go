...
func registerInternalRoutes(api *gin.RouterGroup, h *appHandlers) {
	...
	internal.POST("/telegram/reject-request/peek", h.telegram.PeekPendingReject)
	internal.POST("/telegram/reject-request/pop", h.telegram.PopPendingReject)
	internal.POST("/telegram/reject-request/complete", h.subscription.CompletePendingReject)

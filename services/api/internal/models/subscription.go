...
// SubscriptionReviewSource 标记订阅是如何进入已审核通过状态的。
type SubscriptionReviewSource string

const (
	SubscriptionReviewSourceManual    SubscriptionReviewSource = "MANUAL"
	SubscriptionReviewSourceAutoQuota SubscriptionReviewSource = "AUTO_QUOTA"
)
...
type Subscription struct {
	...
	ReviewSource   *SubscriptionReviewSource `json:"reviewSource,omitempty" gorm:"column:review_source;type:varchar(20)"`

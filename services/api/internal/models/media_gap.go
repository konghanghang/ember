...
type MediaGap struct {
	...
	TmdbID            string         `json:"tmdbId" gorm:"column:tmdbId;size:50;not null;uniqueIndex:uk_media_gap_episode,priority:1"`
	...
	AirDate           time.Time      `json:"airDate" gorm:"column:airDate;not null;index:idx_media_gaps_status_air_date,priority:2"` // date 列，不含时区

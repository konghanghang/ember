...
type ClientBlacklist struct {
	...
	ClientName           string    `json:"clientName" gorm:"column:client_name;size:100;not null"`
	NormalizedClientName string    `json:"-" gorm:"column:normalized_client_name;size:100;uniqueIndex;not null"`
